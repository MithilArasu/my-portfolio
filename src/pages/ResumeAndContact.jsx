...
import { FaEnvelope, FaPhone, FaInstagram, FaDownload } from 'react-icons/fa';

const ResumeAndContact = () => {
  return (
    <section
      id="resume-contact"
      className="bg-[#0d1117] text-white px-6 py-20 md:px-28 font-sans"
    >
      <motion.div
      ...
      >
        ...
        <div className="bg-[#161b22] p-8 rounded-2xl shadow-md w-full lg:w-1/2">
          <h2 className="text-3xl font-bold mb-4 font-lora text-gray-300">
            My Resume
          </h2>
        ...
        <div className="bg-[#161b22] p-8 rounded-2xl shadow-md w-full lg:w-1/2">
          ...
          <div className="space-y-4 text-gray-300 text-sm">
            <div className="flex items-center">
              ...
              <a
                href="mailto:mithilofficial17@gmail.com"
            ...
            <div className="flex items-center">
              <FaInstagram className="text-pink-400 mr-3" />
              <a
